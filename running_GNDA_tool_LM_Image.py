...
model_pat_cat4 = joblib.load('models/patient_classification_LM.m')
...
feature_fnl_c4_list = np.array(PAT_KDP_C3 + PAT_KDP_C2).reshape(1,-1)
final_results = np.argmax(model_pat_cat4.predict_proba(feature_fnl_c4_list)).tolist()
